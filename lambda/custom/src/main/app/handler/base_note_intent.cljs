(ns app.handler.base-note-intent)
...
(defn- handle [handler-input]
  (let [base-note-ja  (get-base-note-ja handler-input)
        base-note-key (note-ja->note-key base-note-ja)
        ...
        speech-text   (str base-note-ja "ですね。"
                           "問題！"
                           audio-tag
                           "音程はなんでしょう？"
                           "(答えは" interval ")")]
